...
function gl_init(gl, vertexShader, fragmentShader) {
   ...
   gl.uLColor   = gl.getUniformLocation(program, "uLColor"  );
   ...
   gl.uSpecP    = gl.getUniformLocation(program, "uSpecP"   );
}
...
function gl_update(gl) {
   ...
   gl.uniform4fv(gl.uSpheres , coordSpheres);                          // Set the coordinates of the spheres.
   gl.uniform1i (gl.uNSpheres, nSpheres);                              // Set the number of spheres.
   gl.uniform3fv(gl.uLColor  , lColorValues);                          // Set color values for the lights
   ...
   gl.uniform1f (gl.uSpecP   , specPower);                             // Set the specular power value
